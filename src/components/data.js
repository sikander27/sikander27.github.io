...
export const portfolioData = {
  ...
  about: `I am a Software Engineer with over ${yearsOfExperience}+ years of experience working with Python (Django/Flask), Golang, ReactJS, and PostgreSQL. With a passion for innovation and an adaptable mindset, I am dedicated to creating outstanding products that positively impact end users.`,
  skills: {
    ...
    "Tools": ["Git", "GitHub", "Celery", "Redis", "RabbitMQ", "Linux", "Docker", "JIRA", "Postman", "Vim"],
  ...
  experience: [
      ...
      role: "SDE-2 (Team Lead)",
      period: "October 2024 - Present",
      companyLink: "https://instahyre.com",
      description: [
    ...
    { 
      ...
      companyLink: "https://influencer.in",
      description: [
    ...
    },
    {
      ...
      companyLink: "https://velocity.net.in",
      description: [
  ...
  education: [
    ...
    {
      institution: "St. John Jr. College, Thane",
      degree: "HSC (Science)",
      period: "",
    }   
  ],
  socials: {
    ...
    linktree: "https://linktr.ee/sikander27"
  }
};